$(function() {
  $('.swagger-frame').each(function() {
    $(this).append('<iframe class="swagger-frame" src="https://maif.github.io/daikoku/swagger-ui/index.html" frameborder="0" style="width:100%;height:100vh;"><iframe>');
  ...
  function setupSearch() {
    ...
    var additionalPath = window.location.host === 'maif.github.io' ? 
      (window.location.pathname.indexOf('devmanual') > -1 ? '/daikoku/devmanual' :  '/daikoku/manual') : '';
