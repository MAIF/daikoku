...
You can download the latest build of Daikoku as a [fat jar](https://github.com/MAIF/daikoku/releases/download/v1.0.0-dev/daikoku.jar) or as a [zip package](https://github.com/MAIF/daikoku/releases/download/v1.0.0-dev/daikoku-dist.zip).
