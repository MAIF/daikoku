...
You can download the latest build of Daikoku as a [fat jar](https://github.com/MAIF/daikoku/releases/download/v1.1.1/daikoku-1.1.1.jar) or as a [zip package](https://github.com/MAIF/daikoku/releases/download/v1.1.1/daikoku-1.1.1.zip).

You can install and run Otoroshi with this little bash snippet :

```sh
curl -L -o daikoku.jar 'https://github.com/MAIF/daikoku/releases/download/v1.1.1/daikoku-1.1.1.jar'
...
```sh
docker run -p "8080:8080" maif/daikoku:1.1.1
```
