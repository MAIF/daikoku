...
You can download the latest build of Daikoku as a [fat jar](https://github.com/MAIF/daikoku/releases/download/v1.0.14/daikoku-1.0.14.jar) or as a [zip package](https://github.com/MAIF/daikoku/releases/download/v1.0.14/daikoku-1.0.14.zip).

You can install and run Otoroshi with this little bash snippet :

```sh
curl -L -o daikoku.jar 'https://github.com/MAIF/daikoku/releases/download/v1.0.14/daikoku-1.0.14.jar'
