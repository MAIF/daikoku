...
Older Daikoku versions used a flat, ad-hoc list of variables (e.g. `--body_bg-color`, `--level2_bg-color`, `--error-color`) with no palette scales and no `--primary-color`. Since __v18.12.0__ Daikoku introduces:
