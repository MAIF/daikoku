    ...
    <div className="modal-content">
      <div className="modal-header">
        <h5 className="modal-title">
          <Translation i18nkey="Contact request" language={props.currentLanguage}>Contact request</Translation>
        </h5>
      ...
      <div className="modal-body">
        <div className="modal-description">
          <form ref={ref => setFormRef(ref)}>
            {!props.name && <div className="form-group">
              <label htmlFor="sender-name">
                <Translation i18nkey="Name" language={props.currentLanguage}>Name</Translation>
              </label>
              <input
            ...
            {!props.email && <div className="form-group">
              <label htmlFor="sender-email">
                <Translation i18nkey="Email address" language={props.currentLanguage}>Email address</Translation>
              </label>
              <input 
            ...
            <div className="form-group">
              <label htmlFor="subject">
                <Translation i18nkey="Subject" language={props.currentLanguage}>Subject</Translation>
              </label>
              <input 
            ...
            <div className="form-group">
              <label htmlFor="message">
                <Translation i18nkey="Message" language={props.currentLanguage}>Message</Translation>
              </label>
              <textarea 
      ...
      <div className="modal-footer">
        ...
        <button
          ...
          onClick={() => sendEmail()}>
          <Translation i18nkey="Send" language={props.currentLanguage}>Send</Translation>
        </button>
      </div>
