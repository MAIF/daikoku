    ...
    case 'Accepted':
      return (
        <a
          ...
          title={moment(date).format(t('moment.date.format', this.props.currentLanguage, 'DD MMM. YYYY à HH:mm z'))}
          disabled>
          <i className="fas fa-check" />
        </a>
      );
      ...
      <div style={style}>
        <div className="alert alert-secondary" role="alert">
          <div className="d-flex justify-content-between align-items-center">
            ...
            <h5 className="alert-heading mb-0">
              {notification.action.type === 'ApiAccess' && (
                <div>
                  <Translation i18nkey="notif.api.access"
              ...
              {notification.action.type === 'TeamAccess' && (
                <div>
                  <Translation i18nkey="notif.membership.team" language={this.props.currentLanguage}>
              ...
              {notification.action.type === 'ApiSubscription' && (
                <div>
                  <Translation i18nkey="notif.api.subscription" 
                    language={this.props.currentLanguage} 
              ...
              {notification.action.type === 'ApiKeyDeletionInformation' && (
                <div>
                  <Translation i18nkey="notif.apikey.deletion"
                    language={this.props.currentLanguage}
                    replacements={[notification.action.clientId, notification.action.api]}>
                    Your apiKey with clientId {notification.action.clientId} for
                    api {notification.action.api} has been deleted
                  </Translation>
                </div>
              )}
          ...
          <div className="d-flex justify-content-between" style={{ fontSize: 12 }}>
            <div className="">
              {this.fromFormatter(notification.action, notification.sender)}
            </div>
