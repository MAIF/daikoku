...
object NotificationAction {
  ...
  case class ApiKeyDeletionInformationV2(api: ApiId, clientId: String, subscription: ApiSubscriptionId)
    extends NotificationAction

  case class ApiKeyRotationInProgressV2(subscription: ApiSubscriptionId, api: ApiId, plan: UsagePlanId)
    extends NotificationAction

  case class ApiKeyRotationEndedV2(subscription: ApiSubscriptionId, api: ApiId, plan: UsagePlanId)
    extends NotificationAction

  case class ApiKeyRefreshV2(subscription: ApiSubscriptionId, api: ApiId, plan: UsagePlanId, message: Option[String] = None)
    extends NotificationAction
