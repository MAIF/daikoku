...
import fr.maif.domain.NotificationAction.{ApiAccess, ApiSubscriptionDemand}
import fr.maif.domain.UsagePlanVisibility.Private
  ...
  def extendApiKey(
    ...
    DaikokuAction.async(parse.json) { ctx =>
      PublicUserAccess(
        ...
        import fr.maif.utils.RequestImplicits.*
