...
import fr.maif.daikoku.domain.{Asset, AssetId}
import fr.maif.daikoku.env.Env
import fr.maif.daikoku.logger.AppLogger
import fr.maif.daikoku.services.{AssetsService, NormalizeSupport}
        ...
        ctx.tenant.bucketSettings match {
          ...
          case Some(cfg) =>
            env.assetsStore
              ...
              case e: fr.maif.daikoku.utils.BadFileContentFromContentType =>
