                  ...
                  env.dataStore.apiRepo
                    ...
                    .map {
                      ...
                      case Some(api) =>
                        Ok(
                          Json
                            .obj("hits" -> Json.obj("count" -> r.nextInt(100)))
                        )
                    }
              }
        }
