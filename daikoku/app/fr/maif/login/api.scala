...
class LoginFilter(env: Env)(implicit
  ...
  import fr.maif.utils.RequestImplicits._
                              ...
                              findUserTeam(tenant.id, user).flatMap {
                                case None =>
                                  ...
                                  FastFuture.successful(
                                    Results
                                      .Redirect(
                                        fr.maif.controllers.routes.LoginController
