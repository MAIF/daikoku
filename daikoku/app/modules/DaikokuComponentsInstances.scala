package fr.maif.otoroshi.daikoku.modules

import com.softwaremill.macwire.wire
import controllers.{Assets, AssetsComponents}
import fr.maif.otoroshi.daikoku.actions._
import fr.maif.otoroshi.daikoku.ctrls._
import fr.maif.otoroshi.daikoku.env.{DaikokuEnv, DaikokuMode, Env}
...
import fr.maif.otoroshi.daikoku.utils.admin.{
  DaikokuApiAction,
  DaikokuApiActionWithoutTenant
}
